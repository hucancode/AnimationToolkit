...
namespace SprinterMNG
{
    ...
    internal class DEFIChunk : MNGChunk
    {
        /// <summary>
        /// The ASCII name of the MNG chunk
        /// </summary>
        public const String NAME = "DEFI";

        private uint objectID;//2 bytes
        private uint doNotShow;//1 byte
        private uint concreteFlag;//1 byte
        private uint xLocation;//4 bytes

        public uint XLocation
        {
        ...
        public uint YLocation
        {
            get { return yLocation; }
            set { yLocation = value; }
        }
        private uint leftClip;//4 bytes
        private uint rightClip;//4 bytes
        private uint topClip;//4 bytes
        ...
        {
            int offset = 0;
            objectID = Utils.ParseUint(chunkData, 2, ref offset);
            doNotShow = Utils.ParseUint(chunkData, 1, ref offset);
            concreteFlag = Utils.ParseUint(chunkData, 1, ref offset);
            xLocation = Utils.ParseUint(chunkData, 4, ref offset);
            yLocation = Utils.ParseUint(chunkData, 4, ref offset);
            leftClip = Utils.ParseUint(chunkData, 4, ref offset);
            rightClip = Utils.ParseUint(chunkData, 4, ref offset);
            topClip = Utils.ParseUint(chunkData, 4, ref offset);
            bottomClip = Utils.ParseUint(chunkData, 4, ref offset);
        }
    }
    ...
    internal class PNG
    {
        ...
        /// <summary>
        /// The PNG file's DEFI chunk
        /// </summary>
        private DEFIChunk defi;
        /// <summary>
    ...
    public class MNG
    {
        ...
        /// <summary>
        /// Get Point object containing the offset of PNG at the specified index
        /// </summary>
        /// <param name="index">The PNG index</param>
        ...
        public int Width
        {
            get { return (int)headerChunk.FrameWidth; }
        }
        public int Height
        {
            get { return (int)headerChunk.FrameHeight; }
        }
        /// <summary>
